...
native apps can generate a unique self-signed certificate. Alternatively, they 
could have used a [browser extension].  In any possible case, this is not a 
valid reason to forget to filter origins.
